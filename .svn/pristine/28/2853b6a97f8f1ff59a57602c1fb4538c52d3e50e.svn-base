    ...
    <script type="text/javascript">
        ...
        $(function () {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row) {
                            ...
                            if (row.taskName.indexOf('已挂起') === -1) {
                                res += '<@shiro.hasPermission name="Leave:leave:list">'
                                        + '<button class="btn btn-xs btn-success partyBtn" taskId="' + row.taskId +'">'
            ...
            $(document).on("click", ".approvalBtn", function () {
                ...
                var url = "${basePath}/leave/showVerifyDialog/" + taskId;
                top.krt.layer.openDialog(taskName, url, "1000px", "500px");
            });
